          ...
          <div className="relative">
            <Card className="overflow-hidden bg-card/50 backdrop-blur border-border/50">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-card-foreground line-clamp-2">{currentArticle.title}</h3>
                  ...
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <Link href={`/blog/${currentArticle.slug}`} className="text-accent hover:underline">
                      Read More
                    </Link>
                  </div>
                </div>
